...
import { setPatientId } from '../../redux/userSlice'; // Import your Redux action
...
function PatientLogin() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Dispatch action to store patient ID in Redux
      dispatch(setPatientId(response.data.patientId));
      
      // Navigate to the patient profile page
      navigate('/patientprofile'); // Adjust the route as necessary
    ...
    <div className="flex justify-center items-center h-screen bg-gray-100">
      <div className="w-full max-w-md p-8 bg-white rounded-lg shadow-lg">
        ...
        <div className="flex gap-2 text-sm mt-2">
          ...
          <Link to="/patientsignup" className="text-blue-500">
            Sign-Up
          </Link>
        </div>
      </div>
